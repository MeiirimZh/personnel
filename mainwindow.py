...
"font: 10pt \"Nirmala UI\";")
        ...
        self.searchCB.setMinimumSize(QtCore.QSize(100, 20))
...
"}")
        ...
        self.sortParamCB.setMinimumSize(QtCore.QSize(100, 20))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.searchCB.setItemText(6, _translate("MainWindow", "Position"))
        ...
        self.sortParamCB.setItemText(5, _translate("MainWindow", "New Item"))
        self.sortParamCB.setItemText(6, _translate("MainWindow", "Education"))
        self.sortParamCB.setItemText(7, _translate("MainWindow", "Position"))
